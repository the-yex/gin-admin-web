...
export class MenuProcessor {
   ...
   * 根据用户permission过滤菜单页
   */
  private filterMenuByRoles(menu: AppRouteRecord[], permissions: Api.SystemManage.Permission[]): AppRouteRecord[] {
    return menu.reduce((acc: AppRouteRecord[], item) => {
      ...
      if (hasPermission) {
        ...
        if (filteredItem.children?.length) {
          filteredItem.children = this.filterMenuByRoles(filteredItem.children, permissions)
        }
